...
u8  pCodeEmulation DTCM_DATA  = 0;     // Default to no p-code card emulation. Will be set '1' only if the user picks the p-code 'cart' and matching 64K special internal GROM.
u8  pcode_bank = 0;
u8  pcode_visible = 0;
